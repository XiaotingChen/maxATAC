...
DEFAULT_EXPONENTIALDECAY_DECAY_RATE = 0.96
DEFAULT_EXPONENTIALDECAY_DECAY_STEPS = 100  # around 12.98% initial lr at 50 epochs with default batch per epoch
DEFAULT_COSINEDECAYRESTART_FIRST_DECAY_STEPS = 5*100
DEFAULT_COSINEDECAYRESTART_ALPHA = 0.1
DEFAULT_COSINEDECAYRESTART_T_MUL = 1.5
DEFAULT_COSINEDECAYRESTART_M_MUL = 0.6
